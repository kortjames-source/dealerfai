...
<body class="dashboard-wrapper">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav" style="background: transparent; padding: 1.5rem 1rem;">
      ...
      <a href="mpi_cap_comparison" class="sidebar-link active">
  ...
  <div class="main-container">
    <header class="top-bar">
      <div class="breadcrumb" style="font-weight: 600; color: #64748b;">
        DealerFAI <i class="fa-solid fa-chevron-right" style="font-size: 0.75rem; margin: 0 0.5rem; opacity: 0.5;"></i> MPI vs CAP Insurance
      </div>
      <div style="display: flex; align-items: center; gap: 1rem;">
        <div style="text-align: right;">
          <div style="font-size: 0.875rem; font-weight: 700; color: #0f172a;"><?= htmlspecialchars($_SESSION['full_name'] ?? 'Finance Manager') ?></div>
        ...
        <div style="width: 40px; height: 40px; background: var(--brand-color); color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-weight: 700;">
          <?= strtoupper(substr($_SESSION['full_name'] ?? 'F', 0, 1)) ?>
        </div>
      </div>
    </header>
    ...
    <main class="page-content" style="padding: 0;">
      <div class="mpi-cap-container">
        ...
        <div class="manager-panel" id="manager-input-panel">
          <div class="manager-panel-header" id="manager-panel-toggle">
            <h3>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
              Finance Manager Setup & MPI Rate Inputs
            </h3>
            <span style="font-size: 0.85rem; color: #64748b; font-weight: 600;" id="panel-toggle-indicator">Click to Collapse ▲</span>
          </div>
  ...
  <script nonce="<?= $nonce ?>">
    document.addEventListener('DOMContentLoaded', () => {
      ...
      function recalculate() {
        ...
        if (activeCapOptions.length === 0) {
          termsContainer.innerHTML = '<div style="color: #64748b; font-style: italic; padding: 1rem 0;">No CAP prices entered. Enter a price in the manager panel above to view customer terms.</div>';
        } else {
