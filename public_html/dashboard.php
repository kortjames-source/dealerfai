...
<?php if ($expiry_warning): ?>
  <div style="background: #fff3cd; border: 1px solid #ffeeba; color: #856404; padding: 15px; border-radius: 5px; max-width: 800px; margin: 20px auto;">
    <strong>Notice:</strong> Your password will expire in <?= $expiry_warning ?> day<?= $expiry_warning == 1 ? '' : 's' ?>. Please update it soon.
  </div>
<?php endif; ?>
